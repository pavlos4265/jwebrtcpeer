...
public class SRTPTransformer implements PacketTransformer {
	 ...
	 *
	 * @param factory the context factory to be used by the new instance for both
	 *                directions.
	 */
	...
	/**
	 * Closes this <tt>SRTPTransformer</tt> and the underlying transform engines.It
	 * closes all stored crypto contexts. It deletes key data and forces a cleanup
	 * of the crypto contexts.
	 */
	public void close() {
		synchronized (contexts) {
	...
	/**
	 * Reverse-transforms a specific packet (i.e. transforms a transformed packet
	 * back).
	 *
	...
	public RawPacket reverseTransform(RawPacket pkt) {
		...
		try {
			return context.reverseTransformPacket(pkt, false) == SRTPErrorStatus.OK ? pkt : null;
		} catch (GeneralSecurityException e) {
